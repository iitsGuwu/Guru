...
import { communityProjects } from "./projects"

export const metadata: Metadata = {
  title: "Community Builds",
  description: "Contributions to projects within web3 — built by the community, for the community.",
}

export default function CommunityPage() {
  return (
    <div className="relative z-10 min-h-screen p-6 md:p-12 max-w-5xl mx-auto space-y-12">
      <Link
        href="/"
      ...
      <div className="space-y-4">
        <h1
          className="text-4xl md:text-6xl font-gothic tracking-[0.2em] uppercase glitch terminal-text"
          data-text="Community Builds"
        >
          Community Builds
        </h1>
        ...
        {communityProjects.map((project) => (
          ...
          >
            <div className="flex items-baseline justify-between">
              ...
              <span className="font-mono text-[10px] text-term terminal-text opacity-0 group-hover:opacity-70 transition-opacity tracking-widest">
                {project.tagline} ↗
              </span>
            </div>
